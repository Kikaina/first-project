...
var UIColorPicker = (function UIColorPicker() {
    ...
    ColorPicker.prototype.createChangeModeButton = function createChangeModeButton() {
        ...
        button.addEventListener(
            'click',
            function() {
                if (this.picker_mode === 'HSV') this.setPickerMode('HSL');
                else this.setPickerMode('HSV');
            }.bind(this)
        );
    ...
    ColorPicker.prototype.updateColor = function updateColor(e) {
        ...
        if (this.picker_mode === 'HSV') this.color.setHSV(this.color.hue, saturation, value);
        if (this.picker_mode === 'HSL') this.color.setHSL(this.color.hue, saturation, value);
    ...
    ColorPicker.prototype.updatePickerPosition = function updatePickerPosition() {
        ...
        if (this.picker_mode === 'HSV') value = this.color.value;
    ...
    var notify = function notify(topic, value) {
        if (subscribers[topic] === undefined || subscribers[topic].length === 0) return;
...
var ColorPickerTool = (function ColorPickerTool() {
    ...
    var ColorPalette = (function ColorPalette() {
        ...
        var createHuePalette = function createHuePalette() {
            var palette = new Palette('H', 20);

            UIColorPicker.subscribe('picker', function(color) {
                if (palette.locked === true) return;

                for (var i = 0; i < 20; i++) {
                    palette.samples[i].updateHue(color, 18, i);
                }
            });
        ...
        var createVLPalette = function createSaturationPalette() {
            ...
            UIColorPicker.subscribe('picker', function(color) {
                ...
                if (color.format === 'HSL') {
                    ...
                    for (var i = 0; i < 11; i++) palette.samples[i].updateLightness(color, -10, i);
                }
                else {
                    palette.title.textContent = 'V';
                    for (var i = 0; i < 11; i++) palette.samples[i].updateBrightness(color, -10, i);
                }
            });
        ...
        var getSampleColor = function getSampleColor(id) {
            if (samples[id] !== undefined && samples[id] !== null) return new Color(samples[id].color);
        };
    ...
    var Tool = (function Tool() {
        ...
        var createPickerModeSwitch = function createPickerModeSwitch() {
            ...
            picker_sw.subscribe(function() {
                if (active === hsv) switchPickingModeTo(hsl);
                else switchPickingModeTo(hsv);
            });
        ...
        var getSampleColorFrom = function getSampleColorFrom(e) {
            ...
            if (location === 'picker-samples') return ColorPickerSamples.getSampleColor(sampleID);
